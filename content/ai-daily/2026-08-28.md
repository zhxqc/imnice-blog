...
> 数据口径：新闻与论文按真实事件时间；Stars 为精确快照差值（基线快照 2026-08-27 15:28 采集 → 本次 08-28 08:04 复采，实际 16.6 小时采样窗口）；新收录仓库无旧基线，标「估算/无基线」。
> 说明：本窗口自昨版日报截稿后起算；此前已报道事件（GLM-5.3-Flash 登顶 OpenRouter、Qwen3.8-Flash-Next、Gemini 3.5 Transcribe、OpenAI HF 事件技术报告、Claude in Chrome 上线等）不重复罗列，仅收录窗口内新增实质进展；NVIDIA Vera CPU 出货等多篇旧闻被 AIHOT 重新抓取，经核对为 5 月旧事件（Twitter 快照 5/18），不纳入。
