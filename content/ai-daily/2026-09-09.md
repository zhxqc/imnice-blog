...
**CoSER 今日无实质更新。** 最近实质提交仍为 2026-04-02（README）；本窗口无新 commit、release、PR；open issues 不变（#12 许可澄清仍 open，最近更新 08-31 已在前期覆盖；另有 2025 年遗留 #8/#9/#10）；HF 数据集页无新文件/新模型、viewer 的既有 cast 报错依旧（非本窗口新增），star 仅 +1（222→223，超过一般噪声阈值但不构成实质变化）。
